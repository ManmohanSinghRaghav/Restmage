...
router.post('/:projectId/layers', auth, async (req, res) => {
  try {
    const project = await Project.findById(req.params.projectId);
...
// Delete map layer
router.delete('/:projectId/layers/:layerId', auth, async (req, res) => {
  try {
    const project = await Project.findById(req.params.projectId);
...
router.put('/:projectId/view', auth, async (req, res) => {
  try {
    const project = await Project.findById(req.params.projectId);
...
router.put('/:projectId/layers/:layerId/visibility', auth, async (req, res) => {
  try {
    const project = await Project.findById(req.params.projectId);
